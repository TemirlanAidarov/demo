...
public class WebService {
    ...
    public void evaluateAnswers(TestRequest testRequest){
        ...
        KeyMap.put("48", "Физико-математическое направление");
        ...
        KeyMap.put("110е", "Художественно-эстетическое направление");
        ...
        KeyMap.put("30А", "Креативность");
        KeyMap.put("56А", "Креативность");
        KeyMap.put("63А", "Креативность");
        KeyMap.put("64А", "Креативность");
        KeyMap.put("66А", "Креативность");
        KeyMap.put("68А", "Креативность");
        KeyMap.put("73А", "Креативность");
        KeyMap.put("98А", "Креативность");
